...
<div class="container bg-light">
   <div class="cart-container text-center">
      <div class="seccontainer shadow p-3">
         <div class="content">
            <p class="checkout text-light bg-dark">CHECKOUT YOUR ITEM</p>
            <h4>Hi, <span><?php echo $_SESSION['buyer_name'] ?></span></h4>
            <h4>Order Summary</h4><br>
            <p></p>
         </div>
         <?php  
            $select = mysqli_query($conn, "SELECT * FROM seller_db WHERE id = '$id'");
            while($row = mysqli_fetch_assoc($select)){
         ?>
         <div class="table">
         <tbody>
         <tr>
            <th><p>PRODUCT:<strong> <?php echo $row['name']; ?></strong></p></th>
            </th><p><br>Total price is:<strong> <?php echo $row['price'];?></strong></p></th>
          <tr>
         <tbody>
         </div>
            <a class="btn btn-primary" href="buyer_page.php">Cancel</a>
            <a class="btn btn-primary" href="sold_item.php" >Buy Now!</a>
            <?php }; ?>
      </div>
   </div>
</div>
